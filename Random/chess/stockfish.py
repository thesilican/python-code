# Copied from https://github.com/zhelyabuzhsky/stockfish
"""
...
class Stockfish:
    ...
    def get_evaluation(self, time: int = 1000) -> dict:
    ...
    def get_move_and_evaluation(self, time: Optional[int] = None) -> Tuple[str, dict]:
        """Evaluates current position
        ...
        while True:
            ...
            if splitted_text[0] == "info":
                ...
                return (splitted_text[1], evaluation)
